...
Updated for Neon PostgreSQL Cloud DB & Vercel Deployment.
"""
import os
...
SECRET_KEY = 'django-insecure-)bacig4l$v%f=-1o%!7t=&ql!dg88sdz5x9h!k4iif=1o0ne$g'
...
DATABASE_URL = os.environ.get('DATABASE_URL', 'postgresql://neondb_owner:npg_TC6IzaF3smEB@ep-bold-waterfall-anseuaqo-pooler.c-6.us-east-1.aws.neon.tech/neondb?sslmode=require')
